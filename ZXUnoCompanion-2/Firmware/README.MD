...
-> Se incluye una versión simplificada del proyecto Joy2PS2 para el segundo puerto de Joystick de Sugarless +2, y sin posibilidad de redefinición de teclas por el momento:
